 ...
 let flavorsList = chip.fields.flavors;
    ...
    var filterSpicy = document.querySelector("#spicy");
     filterSpicy.addEventListener("click", function(){
      ...
      if (chipContianer.classList.contains("spicy")) {
     ...
     filterSweet.addEventListener("click", function(){
      ...
      if (chipContianer.classList.contains("sweet")) {
        chipContainer.style.display = "block"; 
      } else {
        chipContainer.style.display = "none";
      }
     ...
     filterTangy.addEventListener("click", function(){
      ...
      if (chipContianer.classList.contains("tangy")) {
        chipContainer.style.display = "block"; 
      } else {
        chipContainer.style.display = "none";
      }
        ...
        var filterWavy = document.querySelector("#wavy");
     filterWavy.addEventListener("click", function(){

      if (chipContianer.classList.contains("wavy")) {
        chipContainer.style.display = "block"; 
      } else {
        chipContainer.style.display = "none";
      }
